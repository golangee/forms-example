...
// Attach connects the given Invalidator with this Property. If the value of the property has actually changed
// (or is not comparable), the Invalidator is invalidated.
func (p *Property) Attach(in Invalidator) Handle {
